...
- Name: critical-flows.spec.ts >> Critical Flows & Performance >> Error responses follow standard format
- Location: tests\e2e\critical-flows.spec.ts:251:7
...
Received value: {"error": "invalid_credentials"}
```
