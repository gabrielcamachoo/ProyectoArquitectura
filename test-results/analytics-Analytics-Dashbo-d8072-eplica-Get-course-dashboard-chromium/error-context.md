...
- Name: analytics.spec.ts >> Analytics Dashboard (CQRS + Read Replica) >> Get course dashboard
- Location: tests\e2e\analytics.spec.ts:32:7
...
Expected path: "completion_rate"
Received path: []

Received value: {"activeStudents": 24, "atRiskStudents": 3, "averageScore": 71, "completionRate": 93, "courseId": "test-course-1780338468407", "evaluationsSubmitted": 60, "readDb": "postgresql://postgres:postgres@postgres-replica:5432/proyecto", "recommendationsSent": 23, "source": "read-replica", "trend": "up"}
```
