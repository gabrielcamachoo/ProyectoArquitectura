...
export const api = {
  ...
  getEvaluations: () => apiInstance.get('/evaluations').then(res => ({ evaluations: Array.isArray(res.data) ? res.data : (res.data.items || res.data.evaluations || []) })),
  ...
  getForums: () => collaborationAPI.getForums().then(res => ({ items: Array.isArray(res.data) ? res.data : (res.data.items || res.data.forums || []) })),
  createForum: (data: any) => collaborationAPI.createForum(data).then(res => res.data),
  getForumPosts: (forumId: string) => collaborationAPI.getForumPosts(forumId).then(res => ({ items: Array.isArray(res.data) ? res.data : (res.data.items || res.data.posts || []) })),
  createForumPost: (forumId: string, data: any) => collaborationAPI.createForumPost(forumId, data).then(res => res.data),
  getStudyGroups: () => collaborationAPI.getStudyGroups().then(res => ({ items: Array.isArray(res.data) ? res.data : (res.data.items || res.data.groups || []) })),
  createStudyGroup: (data: any) => collaborationAPI.createStudyGroup(data).then(res => res.data),
  getTutoring: (_params?: any) => collaborationAPI.getTutoring().then(res => ({ items: Array.isArray(res.data) ? res.data : (res.data.items || res.data.sessions || []) })),
  ...
  listUsers: () => authAPI.listUsers().then(users => ({ items: Array.isArray(users) ? users : (users as any).items || [] })),
  ...
  getNotifications: (userId: string) => notificationsAPI.getStudentNotifications(userId).then(notifications => ({ items: Array.isArray(notifications) ? notifications : (notifications as any).items || [] })),
