...
CREATE INDEX IF NOT EXISTS idx_progress_student_course ON progress_records(student_id, course_id);
CREATE INDEX IF NOT EXISTS idx_progress_status ON progress_records(status);
